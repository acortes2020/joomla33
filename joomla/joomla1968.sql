...
--
-- Servidor: 10.200.8.233
-- Tiempo de generación: 28-11-2020 a las 14:32:12
...
--
-- Base de datos: `joomla1968`
--

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `joom_action_logs`
--

CREATE TABLE IF NOT EXISTS `joom_action_logs` (
...
--
-- Volcado de datos para la tabla `joom_action_logs`
--

INSERT INTO `joom_action_logs` (`id`, `message_language_key`, `message`, `log_date`, `extension`, `user_id`, `item_id`, `ip_address`) VALUES
(1, 'PLG_ACTIONLOG_JOOMLA_USER_LOGGED_IN', '{"action":"login","userid":"607","username":"acortes","accountlink":"index.php?option=com_users&task=user.edit&id=607","app":"PLG_ACTIONLOG_JOOMLA_APPLICATION_ADMINISTRATOR"}', '2020-11-28 11:32:53', 'com_users', 607, 0, 'COM_ACTIONLOGS_DISABLED'),
(2, 'PLG_ACTIONLOG_JOOMLA_USER_LOGGED_IN', '{"action":"login","userid":"607","username":"acortes","accountlink":"index.php?option=com_users&task=user.edit&id=607","app":"PLG_ACTIONLOG_JOOMLA_APPLICATION_SITE"}', '2020-11-28 11:36:29', 'com_users', 607, 0, 'COM_ACTIONLOGS_DISABLED'),
(3, 'PLG_ACTIONLOG_JOOMLA_USER_LOGGED_OUT', '{"action":"logout","id":"607","userid":"607","username":"acortes","accountlink":"index.php?option=com_users&task=user.edit&id=607","app":"PLG_ACTIONLOG_JOOMLA_APPLICATION_SITE"}', '2020-11-28 11:36:42', 'com_users', 607, 607, 'COM_ACTIONLOGS_DISABLED'),
(4, 'PLG_ACTIONLOG_JOOMLA_USER_LOGGED_OUT', '{"action":"logout","id":"607","userid":"607","username":"acortes","accountlink":"index.php?option=com_users&task=user.edit&id=607","app":"PLG_ACTIONLOG_JOOMLA_APPLICATION_ADMINISTRATOR"}', '2020-11-28 11:36:59', 'com_users', 607, 607, 'COM_ACTIONLOGS_DISABLED');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `joom_action_logs_extensions`
--

CREATE TABLE IF NOT EXISTS `joom_action_logs_extensions` (
  `id` int(10) unsigned NOT NULL,
  `extension` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT ''
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Volcado de datos para la tabla `joom_action_logs_extensions`
--

INSERT INTO `joom_action_logs_extensions` (`id`, `extension`) VALUES
(1, 'com_banners'),
(2, 'com_cache'),
(3, 'com_categories'),
(4, 'com_config'),
...
--
-- Estructura de tabla para la tabla `joom_action_logs_users`
--

CREATE TABLE IF NOT EXISTS `joom_action_logs_users` (
...
--
-- Estructura de tabla para la tabla `joom_action_log_config`
--

CREATE TABLE IF NOT EXISTS `joom_action_log_config` (
  `id` int(10) unsigned NOT NULL,
...
--
-- Volcado de datos para la tabla `joom_action_log_config`
--

INSERT INTO `joom_action_log_config` (`id`, `type_title`, `type_alias`, `id_holder`, `title_holder`, `table_name`, `text_prefix`) VALUES
...
--
-- Estructura de tabla para la tabla `joom_assets`
--
...
--
-- Volcado de datos para la tabla `joom_assets`
--
...
--
-- Estructura de tabla para la tabla `joom_associations`
--
...
--
-- Estructura de tabla para la tabla `joom_banners`
--
...
--
-- Estructura de tabla para la tabla `joom_banner_clients`
--
...
--
-- Estructura de tabla para la tabla `joom_banner_tracks`
--
...
--
-- Estructura de tabla para la tabla `joom_categories`
--
...
--
-- Volcado de datos para la tabla `joom_categories`
--
...
(1, 0, 0, 0, 11, 0, '', 'system', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '{}', 607, '2020-11-28 11:28:58', 0, '0000-00-00 00:00:00', 0, '*', 1),
(2, 27, 1, 1, 2, 1, 'uncategorised', 'com_content', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 607, '2020-11-28 11:28:58', 0, '0000-00-00 00:00:00', 0, '*', 1),
(3, 28, 1, 3, 4, 1, 'uncategorised', 'com_banners', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 607, '2020-11-28 11:28:58', 0, '0000-00-00 00:00:00', 0, '*', 1),
(4, 29, 1, 5, 6, 1, 'uncategorised', 'com_contact', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 607, '2020-11-28 11:28:58', 0, '0000-00-00 00:00:00', 0, '*', 1),
(5, 30, 1, 7, 8, 1, 'uncategorised', 'com_newsfeeds', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 607, '2020-11-28 11:28:58', 0, '0000-00-00 00:00:00', 0, '*', 1),
(7, 32, 1, 9, 10, 1, 'uncategorised', 'com_users', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 607, '2020-11-28 11:28:58', 0, '0000-00-00 00:00:00', 0, '*', 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `joom_contact_details`
--
...
--
-- Estructura de tabla para la tabla `joom_content`
--
...
--
-- Estructura de tabla para la tabla `joom_contentitem_tag_map`
--
...
--
-- Estructura de tabla para la tabla `joom_content_frontpage`
--
...
--
-- Estructura de tabla para la tabla `joom_content_rating`
--
...
--
-- Estructura de tabla para la tabla `joom_content_types`
--
...
--
-- Volcado de datos para la tabla `joom_content_types`
--
...
--
-- Estructura de tabla para la tabla `joom_core_log_searches`
--
...
--
-- Estructura de tabla para la tabla `joom_extensions`
--
...
--
-- Volcado de datos para la tabla `joom_extensions`
--

INSERT INTO `joom_extensions` (`extension_id`, `package_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(103, 0, 'LIB_JOOMLA', 'library', 'joomla', '', 0, 1, 1, 1, '{"name":"LIB_JOOMLA","type":"library","creationDate":"2008","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2020 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"https:\\/\\/www.joomla.org","version":"13.1","description":"LIB_JOOMLA_XML_DESCRIPTION","group":"","filename":"joomla"}', '{"mediaversion":"8561f4435d033745bff9580c67812216"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(452, 0, 'plg_system_updatenotification', 'plugin', 'updatenotification', 'system', 0, 1, 1, 0, '{"name":"plg_system_updatenotification","type":"plugin","creationDate":"May 2015","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2020 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"3.5.0","description":"PLG_SYSTEM_UPDATENOTIFICATION_XML_DESCRIPTION","group":"","filename":"updatenotification"}', '{"lastrun":1606563157}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
--
-- Estructura de tabla para la tabla `joom_fields`
--

CREATE TABLE IF NOT EXISTS `joom_fields` (
  `id` int(10) unsigned NOT NULL,
...
--
-- Estructura de tabla para la tabla `joom_fields_categories`
--

CREATE TABLE IF NOT EXISTS `joom_fields_categories` (
...
--
-- Estructura de tabla para la tabla `joom_fields_groups`
--

CREATE TABLE IF NOT EXISTS `joom_fields_groups` (
  `id` int(10) unsigned NOT NULL,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0',
  `context` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Estructura de tabla para la tabla `joom_fields_values`
--

CREATE TABLE IF NOT EXISTS `joom_fields_values` (
...
--
-- Estructura de tabla para la tabla `joom_finder_filters`
--
...
--
-- Estructura de tabla para la tabla `joom_finder_links`
--
...
--
-- Estructura de tabla para la tabla `joom_finder_links_terms0`
--
...
--
-- Estructura de tabla para la tabla `joom_finder_links_terms1`
--
...
--
-- Estructura de tabla para la tabla `joom_finder_links_terms2`
--
...
--
-- Estructura de tabla para la tabla `joom_finder_links_terms3`
--
...
--
-- Estructura de tabla para la tabla `joom_finder_links_terms4`
--
...
--
-- Estructura de tabla para la tabla `joom_finder_links_terms5`
--
...
--
-- Estructura de tabla para la tabla `joom_finder_links_terms6`
--
...
--
-- Estructura de tabla para la tabla `joom_finder_links_terms7`
--
...
--
-- Estructura de tabla para la tabla `joom_finder_links_terms8`
--
...
--
-- Estructura de tabla para la tabla `joom_finder_links_terms9`
--
...
--
-- Estructura de tabla para la tabla `joom_finder_links_termsa`
--
...
--
-- Estructura de tabla para la tabla `joom_finder_links_termsb`
--
...
--
-- Estructura de tabla para la tabla `joom_finder_links_termsc`
--
...
--
-- Estructura de tabla para la tabla `joom_finder_links_termsd`
--
...
--
-- Estructura de tabla para la tabla `joom_finder_links_termse`
--
...
--
-- Estructura de tabla para la tabla `joom_finder_links_termsf`
--
...
--
-- Estructura de tabla para la tabla `joom_finder_taxonomy`
--
...
--
-- Volcado de datos para la tabla `joom_finder_taxonomy`
--
...
--
-- Estructura de tabla para la tabla `joom_finder_taxonomy_map`
--
...
--
-- Estructura de tabla para la tabla `joom_finder_terms`
--
...
--
-- Estructura de tabla para la tabla `joom_finder_terms_common`
--
...
--
-- Volcado de datos para la tabla `joom_finder_terms_common`
--
...
--
-- Estructura de tabla para la tabla `joom_finder_tokens`
--
...
--
-- Estructura de tabla para la tabla `joom_finder_tokens_aggregate`
--
...
--
-- Estructura de tabla para la tabla `joom_finder_types`
--
...
--
-- Estructura de tabla para la tabla `joom_languages`
--
...
--
-- Volcado de datos para la tabla `joom_languages`
--

INSERT INTO `joom_languages` (`lang_id`, `asset_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 0, 'en-GB', 'English (en-GB)', 'English (United Kingdom)', 'en', 'en_gb', '', '', '', '', 1, 1, 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `joom_menu`
--
...
--
-- Volcado de datos para la tabla `joom_menu`
--
...
--
-- Estructura de tabla para la tabla `joom_menu_types`
--
...
--
-- Volcado de datos para la tabla `joom_menu_types`
--

INSERT INTO `joom_menu_types` (`id`, `asset_id`, `menutype`, `title`, `description`, `client_id`) VALUES
(1, 0, 'mainmenu', 'Main Menu', 'The main menu for the site', 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `joom_messages`
--
...
--
-- Estructura de tabla para la tabla `joom_messages_cfg`
--
...
--
-- Estructura de tabla para la tabla `joom_modules`
--
...
--
-- Volcado de datos para la tabla `joom_modules`
--
...
--
-- Estructura de tabla para la tabla `joom_modules_menu`
--
...
--
-- Volcado de datos para la tabla `joom_modules_menu`
--
...
--
-- Estructura de tabla para la tabla `joom_newsfeeds`
--
...
--
-- Estructura de tabla para la tabla `joom_overrider`
--
...
--
-- Estructura de tabla para la tabla `joom_postinstall_messages`
--
...
--
-- Volcado de datos para la tabla `joom_postinstall_messages`
--
...
--
-- Estructura de tabla para la tabla `joom_privacy_consents`
--

CREATE TABLE IF NOT EXISTS `joom_privacy_consents` (
  `id` int(10) unsigned NOT NULL,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Estructura de tabla para la tabla `joom_privacy_requests`
--

CREATE TABLE IF NOT EXISTS `joom_privacy_requests` (
  `id` int(10) unsigned NOT NULL,
...
--
-- Estructura de tabla para la tabla `joom_redirect_links`
--
...
--
-- Estructura de tabla para la tabla `joom_schemas`
--
...
--
-- Volcado de datos para la tabla `joom_schemas`
--
...
--
-- Estructura de tabla para la tabla `joom_session`
--
...
--
-- Volcado de datos para la tabla `joom_session`
--

INSERT INTO `joom_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
(0x61666a6d6a36306d656b36376d76756367373870383773676d6a6b6c6c716539, 1, 1, 1606563419, 'joomla|s:736:"";', 0, ''),
(0x753069636739613934616739386c3836616b626d6975766b316b6d3676626164, 0, 1, 1606563402, 'joomla|s:736:"";', 0, '');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `joom_tags`
--
...
--
-- Volcado de datos para la tabla `joom_tags`
--
...
(1, 0, 0, 1, 0, '', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '', '', '', '', 607, '2020-11-28 11:28:58', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `joom_template_styles`
--
...
--
-- Volcado de datos para la tabla `joom_template_styles`
--
...
--
-- Estructura de tabla para la tabla `joom_ucm_base`
--
...
--
-- Estructura de tabla para la tabla `joom_ucm_content`
--
...
--
-- Estructura de tabla para la tabla `joom_ucm_history`
--
...
--
-- Estructura de tabla para la tabla `joom_updates`
--
...
--
-- Volcado de datos para la tabla `joom_updates`
--
...
(4, 2, 0, 'Flemish', '', 'pkg_nl-BE', 'package', '', 0, '3.9.23.1', '', 'https://update.joomla.org/language/details3/nl-BE_details.xml', '', ''),
(5, 2, 0, 'Chinese Traditional', '', 'pkg_zh-TW', 'package', '', 0, '3.8.0.1', '', 'https://update.joomla.org/language/details3/zh-TW_details.xml', '', ''),
(6, 2, 0, 'French', '', 'pkg_fr-FR', 'package', '', 0, '3.9.23.1', '', 'https://update.joomla.org/language/details3/fr-FR_details.xml', '', ''),
(7, 2, 0, 'Galician', '', 'pkg_gl-ES', 'package', '', 0, '3.3.1.2', '', 'https://update.joomla.org/language/details3/gl-ES_details.xml', '', ''),
(8, 2, 0, 'Georgian', '', 'pkg_ka-GE', 'package', '', 0, '3.9.23.1', '', 'https://update.joomla.org/language/details3/ka-GE_details.xml', '', ''),
(9, 2, 0, 'Greek', '', 'pkg_el-GR', 'package', '', 0, '3.9.23.1', '', 'https://update.joomla.org/language/details3/el-GR_details.xml', '', ''),
(10, 2, 0, 'Japanese', '', 'pkg_ja-JP', 'package', '', 0, '3.9.23.1', '', 'https://update.joomla.org/language/details3/ja-JP_details.xml', '', ''),
...
(19, 2, 0, 'Chinese Simplified', '', 'pkg_zh-CN', 'package', '', 0, '3.9.23.1', '', 'https://update.joomla.org/language/details3/zh-CN_details.xml', '', ''),
(20, 2, 0, 'Croatian', '', 'pkg_hr-HR', 'package', '', 0, '3.9.23.1', '', 'https://update.joomla.org/language/details3/hr-HR_details.xml', '', ''),
(21, 2, 0, 'Czech', '', 'pkg_cs-CZ', 'package', '', 0, '3.9.22.2', '', 'https://update.joomla.org/language/details3/cs-CZ_details.xml', '', ''),
(22, 2, 0, 'Danish', '', 'pkg_da-DK', 'package', '', 0, '3.9.23.1', '', 'https://update.joomla.org/language/details3/da-DK_details.xml', '', ''),
(23, 2, 0, 'Dutch', '', 'pkg_nl-NL', 'package', '', 0, '3.9.23.1', '', 'https://update.joomla.org/language/details3/nl-NL_details.xml', '', ''),
...
(26, 2, 0, 'Italian', '', 'pkg_it-IT', 'package', '', 0, '3.9.23.1', '', 'https://update.joomla.org/language/details3/it-IT_details.xml', '', ''),
...
(34, 2, 0, 'Persian', '', 'pkg_fa-IR', 'package', '', 0, '3.9.23.1', '', 'https://update.joomla.org/language/details3/fa-IR_details.xml', '', ''),
...
(37, 2, 0, 'Russian', '', 'pkg_ru-RU', 'package', '', 0, '3.9.22.1', '', 'https://update.joomla.org/language/details3/ru-RU_details.xml', '', ''),
(38, 2, 0, 'English AU', '', 'pkg_en-AU', 'package', '', 0, '3.9.23.1', '', 'https://update.joomla.org/language/details3/en-AU_details.xml', '', ''),
(39, 2, 0, 'Slovak', '', 'pkg_sk-SK', 'package', '', 0, '3.9.23.1', '', 'https://update.joomla.org/language/details3/sk-SK_details.xml', '', ''),
(40, 2, 0, 'English US', '', 'pkg_en-US', 'package', '', 0, '3.9.23.1', '', 'https://update.joomla.org/language/details3/en-US_details.xml', '', ''),
(41, 2, 0, 'Swedish', '', 'pkg_sv-SE', 'package', '', 0, '3.9.23.1', '', 'https://update.joomla.org/language/details3/sv-SE_details.xml', '', ''),
(42, 2, 0, 'Syriac', '', 'pkg_sy-IQ', 'package', '', 0, '3.4.5.1', '', 'https://update.joomla.org/language/details3/sy-IQ_details.xml', '', ''),
(43, 2, 0, 'Tamil', '', 'pkg_ta-IN', 'package', '', 0, '3.9.23.1', '', 'https://update.joomla.org/language/details3/ta-IN_details.xml', '', ''),
(44, 2, 0, 'Thai', '', 'pkg_th-TH', 'package', '', 0, '3.9.23.1', '', 'https://update.joomla.org/language/details3/th-TH_details.xml', '', ''),
(45, 2, 0, 'Turkish', '', 'pkg_tr-TR', 'package', '', 0, '3.9.4.1', '', 'https://update.joomla.org/language/details3/tr-TR_details.xml', '', ''),
(46, 2, 0, 'Ukrainian', '', 'pkg_uk-UA', 'package', '', 0, '3.9.22.1', '', 'https://update.joomla.org/language/details3/uk-UA_details.xml', '', ''),
...
(51, 2, 0, 'German DE', '', 'pkg_de-DE', 'package', '', 0, '3.9.23.1', '', 'https://update.joomla.org/language/details3/de-DE_details.xml', '', ''),
(52, 2, 0, 'Portuguese Brazil', '', 'pkg_pt-BR', 'package', '', 0, '3.9.21.1', '', 'https://update.joomla.org/language/details3/pt-BR_details.xml', '', ''),
(53, 2, 0, 'Serbian Latin', '', 'pkg_sr-YU', 'package', '', 0, '3.9.23.1', '', 'https://update.joomla.org/language/details3/sr-YU_details.xml', '', ''),
(54, 2, 0, 'Spanish', '', 'pkg_es-ES', 'package', '', 0, '3.9.18.1', '', 'https://update.joomla.org/language/details3/es-ES_details.xml', '', ''),
(55, 2, 0, 'Bosnian', '', 'pkg_bs-BA', 'package', '', 0, '3.9.23.1', '', 'https://update.joomla.org/language/details3/bs-BA_details.xml', '', ''),
(56, 2, 0, 'Serbian Cyrillic', '', 'pkg_sr-RS', 'package', '', 0, '3.9.23.1', '', 'https://update.joomla.org/language/details3/sr-RS_details.xml', '', ''),
...
(60, 2, 0, 'Swahili', '', 'pkg_sw-KE', 'package', '', 0, '3.9.23.1', '', 'https://update.joomla.org/language/details3/sw-KE_details.xml', '', ''),
...
(70, 2, 0, 'Slovenian', '', 'pkg_sl-SI', 'package', '', 0, '3.9.23.1', '', 'https://update.joomla.org/language/details3/sl-SI_details.xml', '', ''),
(71, 2, 0, 'Spanish CO', '', 'pkg_es-CO', 'package', '', 0, '3.9.15.1', '', 'https://update.joomla.org/language/details3/es-CO_details.xml', '', ''),
(72, 2, 0, 'German CH', '', 'pkg_de-CH', 'package', '', 0, '3.9.23.1', '', 'https://update.joomla.org/language/details3/de-CH_details.xml', '', ''),
(73, 2, 0, 'German AT', '', 'pkg_de-AT', 'package', '', 0, '3.9.23.1', '', 'https://update.joomla.org/language/details3/de-AT_details.xml', '', ''),
(74, 2, 0, 'German LI', '', 'pkg_de-LI', 'package', '', 0, '3.9.23.1', '', 'https://update.joomla.org/language/details3/de-LI_details.xml', '', ''),
(75, 2, 0, 'German LU', '', 'pkg_de-LU', 'package', '', 0, '3.9.23.1', '', 'https://update.joomla.org/language/details3/de-LU_details.xml', '', ''),
(76, 2, 0, 'English NZ', '', 'pkg_en-NZ', 'package', '', 0, '3.9.23.1', '', 'https://update.joomla.org/language/details3/en-NZ_details.xml', '', ''),
(77, 2, 0, 'Kazakh', '', 'pkg_kk-KZ', 'package', '', 0, '3.9.21.1', '', 'https://update.joomla.org/language/details3/kk-KZ_details.xml', '', '');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `joom_update_sites`
--
...
--
-- Volcado de datos para la tabla `joom_update_sites`
--

INSERT INTO `joom_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
(1, 'Joomla! Core', 'collection', 'https://update.joomla.org/core/list.xml', 1, 1606563157, ''),
(2, 'Accredited Joomla! Translations', 'collection', 'https://update.joomla.org/language/translationlist_3.xml', 1, 1606563174, ''),
(3, 'Joomla! Update Component Update Site', 'extension', 'https://update.joomla.org/core/extensions/com_joomlaupdate.xml', 1, 1606563174, '');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `joom_update_sites_extensions`
--
...
--
-- Volcado de datos para la tabla `joom_update_sites_extensions`
--
...
--
-- Estructura de tabla para la tabla `joom_usergroups`
--
...
--
-- Volcado de datos para la tabla `joom_usergroups`
--
...
--
-- Estructura de tabla para la tabla `joom_users`
--
...
--
-- Volcado de datos para la tabla `joom_users`
--
...
(607, 'Super User', 'acortes', 'cortes.linan.abel@iescamas.es', '$2y$10$sVytpi4nGUzV4ETgtYy.DOz0gHhadoaeWbtXW9heEXw3C7o.2FjFG', 0, 1, '2020-11-28 11:28:59', '2020-11-28 11:36:59', '0', '', '0000-00-00 00:00:00', 0, '', '', 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `joom_user_keys`
--
...
--
-- Estructura de tabla para la tabla `joom_user_notes`
--
...
--
-- Estructura de tabla para la tabla `joom_user_profiles`
--
...
--
-- Estructura de tabla para la tabla `joom_user_usergroup_map`
--
...
--
-- Volcado de datos para la tabla `joom_user_usergroup_map`
--
...
--
-- Estructura de tabla para la tabla `joom_utf8_conversion`
--

CREATE TABLE IF NOT EXISTS `joom_utf8_conversion` (
  `converted` tinyint(4) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Volcado de datos para la tabla `joom_utf8_conversion`
--

INSERT INTO `joom_utf8_conversion` (`converted`) VALUES
(5);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `joom_viewlevels`
--
...
--
-- Volcado de datos para la tabla `joom_viewlevels`
--
...
--
-- Indices de la tabla `joom_action_logs`
--
ALTER TABLE `joom_action_logs`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `joom_action_logs_extensions`
--
ALTER TABLE `joom_action_logs_extensions`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `joom_action_logs_users`
--
ALTER TABLE `joom_action_logs_users`
  ADD PRIMARY KEY (`user_id`),
  ADD KEY `idx_notify` (`notify`);

--
-- Indices de la tabla `joom_action_log_config`
--
ALTER TABLE `joom_action_log_config`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `joom_assets`
--
ALTER TABLE `joom_assets`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `joom_associations`
--
ALTER TABLE `joom_associations`
  ADD PRIMARY KEY (`context`,`id`),
  ADD KEY `idx_key` (`key`);

--
-- Indices de la tabla `joom_banners`
--
ALTER TABLE `joom_banners`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `joom_banner_clients`
--
ALTER TABLE `joom_banner_clients`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_own_prefix` (`own_prefix`),
  ADD KEY `idx_metakey_prefix` (`metakey_prefix`(100));

--
-- Indices de la tabla `joom_banner_tracks`
--
ALTER TABLE `joom_banner_tracks`
...
--
-- Indices de la tabla `joom_categories`
--
ALTER TABLE `joom_categories`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `joom_contact_details`
--
ALTER TABLE `joom_contact_details`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
...
--
-- Indices de la tabla `joom_content`
--
...
--
-- Indices de la tabla `joom_contentitem_tag_map`
--
ALTER TABLE `joom_contentitem_tag_map`
...
--
-- Indices de la tabla `joom_content_frontpage`
--
ALTER TABLE `joom_content_frontpage`
  ADD PRIMARY KEY (`content_id`);

--
-- Indices de la tabla `joom_content_rating`
--
ALTER TABLE `joom_content_rating`
  ADD PRIMARY KEY (`content_id`);

--
-- Indices de la tabla `joom_content_types`
--
ALTER TABLE `joom_content_types`
  ADD PRIMARY KEY (`type_id`),
  ADD KEY `idx_alias` (`type_alias`(100));

--
-- Indices de la tabla `joom_extensions`
--
ALTER TABLE `joom_extensions`
...
--
-- Indices de la tabla `joom_fields`
--
ALTER TABLE `joom_fields`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Indices de la tabla `joom_fields_categories`
--
ALTER TABLE `joom_fields_categories`
  ADD PRIMARY KEY (`field_id`,`category_id`);

--
-- Indices de la tabla `joom_fields_groups`
--
ALTER TABLE `joom_fields_groups`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Indices de la tabla `joom_fields_values`
--
ALTER TABLE `joom_fields_values`
  ADD KEY `idx_field_id` (`field_id`),
  ADD KEY `idx_item_id` (`item_id`(191));

--
-- Indices de la tabla `joom_finder_filters`
--
ALTER TABLE `joom_finder_filters`
  ADD PRIMARY KEY (`filter_id`);

--
-- Indices de la tabla `joom_finder_links`
--
ALTER TABLE `joom_finder_links`
...
--
-- Indices de la tabla `joom_finder_links_terms0`
--
ALTER TABLE `joom_finder_links_terms0`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `joom_finder_links_terms1`
--
ALTER TABLE `joom_finder_links_terms1`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `joom_finder_links_terms2`
--
ALTER TABLE `joom_finder_links_terms2`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `joom_finder_links_terms3`
--
ALTER TABLE `joom_finder_links_terms3`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `joom_finder_links_terms4`
--
ALTER TABLE `joom_finder_links_terms4`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `joom_finder_links_terms5`
--
ALTER TABLE `joom_finder_links_terms5`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `joom_finder_links_terms6`
--
ALTER TABLE `joom_finder_links_terms6`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `joom_finder_links_terms7`
--
ALTER TABLE `joom_finder_links_terms7`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `joom_finder_links_terms8`
--
ALTER TABLE `joom_finder_links_terms8`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `joom_finder_links_terms9`
--
ALTER TABLE `joom_finder_links_terms9`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `joom_finder_links_termsa`
--
ALTER TABLE `joom_finder_links_termsa`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `joom_finder_links_termsb`
--
ALTER TABLE `joom_finder_links_termsb`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `joom_finder_links_termsc`
--
ALTER TABLE `joom_finder_links_termsc`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `joom_finder_links_termsd`
--
ALTER TABLE `joom_finder_links_termsd`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `joom_finder_links_termse`
--
ALTER TABLE `joom_finder_links_termse`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `joom_finder_links_termsf`
--
ALTER TABLE `joom_finder_links_termsf`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indices de la tabla `joom_finder_taxonomy`
--
ALTER TABLE `joom_finder_taxonomy`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `joom_finder_taxonomy_map`
--
ALTER TABLE `joom_finder_taxonomy_map`
  ADD PRIMARY KEY (`link_id`,`node_id`),
  ADD KEY `link_id` (`link_id`),
  ADD KEY `node_id` (`node_id`);

--
-- Indices de la tabla `joom_finder_terms`
--
ALTER TABLE `joom_finder_terms`
...
--
-- Indices de la tabla `joom_finder_terms_common`
--
ALTER TABLE `joom_finder_terms_common`
  ADD KEY `idx_word_lang` (`term`,`language`),
  ADD KEY `idx_lang` (`language`);

--
-- Indices de la tabla `joom_finder_tokens`
--
ALTER TABLE `joom_finder_tokens`
  ADD KEY `idx_word` (`term`),
  ADD KEY `idx_context` (`context`);

--
-- Indices de la tabla `joom_finder_tokens_aggregate`
--
ALTER TABLE `joom_finder_tokens_aggregate`
  ADD KEY `token` (`term`),
  ADD KEY `keyword_id` (`term_id`);

--
-- Indices de la tabla `joom_finder_types`
--
ALTER TABLE `joom_finder_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `title` (`title`);

--
-- Indices de la tabla `joom_languages`
--
ALTER TABLE `joom_languages`
...
--
-- Indices de la tabla `joom_menu`
--
ALTER TABLE `joom_menu`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `joom_menu_types`
--
ALTER TABLE `joom_menu_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `idx_menutype` (`menutype`);

--
-- Indices de la tabla `joom_messages`
--
ALTER TABLE `joom_messages`
  ADD PRIMARY KEY (`message_id`),
  ADD KEY `useridto_state` (`user_id_to`,`state`);

--
-- Indices de la tabla `joom_messages_cfg`
--
ALTER TABLE `joom_messages_cfg`
  ADD UNIQUE KEY `idx_user_var_name` (`user_id`,`cfg_name`);

--
-- Indices de la tabla `joom_modules`
--
ALTER TABLE `joom_modules`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `joom_modules_menu`
--
ALTER TABLE `joom_modules_menu`
  ADD PRIMARY KEY (`moduleid`,`menuid`);

--
-- Indices de la tabla `joom_newsfeeds`
--
ALTER TABLE `joom_newsfeeds`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`published`),
...
--
-- Indices de la tabla `joom_overrider`
--
ALTER TABLE `joom_overrider`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `joom_postinstall_messages`
--
ALTER TABLE `joom_postinstall_messages`
  ADD PRIMARY KEY (`postinstall_message_id`);

--
-- Indices de la tabla `joom_privacy_consents`
--
ALTER TABLE `joom_privacy_consents`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_user_id` (`user_id`);

--
-- Indices de la tabla `joom_privacy_requests`
--
ALTER TABLE `joom_privacy_requests`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `joom_redirect_links`
--
ALTER TABLE `joom_redirect_links`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_old_url` (`old_url`(100)),
  ADD KEY `idx_link_modifed` (`modified_date`);

--
-- Indices de la tabla `joom_schemas`
--
ALTER TABLE `joom_schemas`
  ADD PRIMARY KEY (`extension_id`,`version_id`);

--
-- Indices de la tabla `joom_session`
--
ALTER TABLE `joom_session`
...
--
-- Indices de la tabla `joom_tags`
--
ALTER TABLE `joom_tags`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `joom_template_styles`
--
ALTER TABLE `joom_template_styles`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `joom_ucm_base`
--
ALTER TABLE `joom_ucm_base`
...
--
-- Indices de la tabla `joom_ucm_content`
--
ALTER TABLE `joom_ucm_content`
...
--
-- Indices de la tabla `joom_ucm_history`
--
ALTER TABLE `joom_ucm_history`
  ADD PRIMARY KEY (`version_id`),
  ADD KEY `idx_ucm_item_id` (`ucm_type_id`,`ucm_item_id`),
  ADD KEY `idx_save_date` (`save_date`);

--
-- Indices de la tabla `joom_updates`
--
ALTER TABLE `joom_updates`
  ADD PRIMARY KEY (`update_id`);

--
-- Indices de la tabla `joom_update_sites`
--
ALTER TABLE `joom_update_sites`
  ADD PRIMARY KEY (`update_site_id`);

--
-- Indices de la tabla `joom_update_sites_extensions`
--
ALTER TABLE `joom_update_sites_extensions`
  ADD PRIMARY KEY (`update_site_id`,`extension_id`);

--
-- Indices de la tabla `joom_usergroups`
--
ALTER TABLE `joom_usergroups`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `joom_users`
--
ALTER TABLE `joom_users`
  ADD PRIMARY KEY (`id`),
...
--
-- Indices de la tabla `joom_user_keys`
--
ALTER TABLE `joom_user_keys`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `series` (`series`),
  ADD KEY `user_id` (`user_id`);

--
-- Indices de la tabla `joom_user_notes`
--
ALTER TABLE `joom_user_notes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_user_id` (`user_id`),
  ADD KEY `idx_category_id` (`catid`);

--
-- Indices de la tabla `joom_user_profiles`
--
ALTER TABLE `joom_user_profiles`
  ADD UNIQUE KEY `idx_user_id_profile_key` (`user_id`,`profile_key`);

--
-- Indices de la tabla `joom_user_usergroup_map`
--
ALTER TABLE `joom_user_usergroup_map`
  ADD PRIMARY KEY (`user_id`,`group_id`);

--
-- Indices de la tabla `joom_viewlevels`
--
ALTER TABLE `joom_viewlevels`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT de la tabla `joom_action_logs`
--
ALTER TABLE `joom_action_logs`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT de la tabla `joom_action_logs_extensions`
--
ALTER TABLE `joom_action_logs_extensions`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=19;
--
-- AUTO_INCREMENT de la tabla `joom_action_log_config`
--
ALTER TABLE `joom_action_log_config`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=20;
--
-- AUTO_INCREMENT de la tabla `joom_assets`
--
ALTER TABLE `joom_assets`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',AUTO_INCREMENT=60;
--
-- AUTO_INCREMENT de la tabla `joom_banners`
--
ALTER TABLE `joom_banners`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `joom_banner_clients`
--
ALTER TABLE `joom_banner_clients`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `joom_categories`
--
ALTER TABLE `joom_categories`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT de la tabla `joom_contact_details`
--
ALTER TABLE `joom_contact_details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `joom_content`
--
ALTER TABLE `joom_content`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `joom_content_types`
--
ALTER TABLE `joom_content_types`
  MODIFY `type_id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10000;
--
-- AUTO_INCREMENT de la tabla `joom_extensions`
--
ALTER TABLE `joom_extensions`
  MODIFY `extension_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10000;
--
-- AUTO_INCREMENT de la tabla `joom_fields`
--
ALTER TABLE `joom_fields`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `joom_fields_groups`
--
ALTER TABLE `joom_fields_groups`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `joom_finder_filters`
--
ALTER TABLE `joom_finder_filters`
  MODIFY `filter_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `joom_finder_links`
--
ALTER TABLE `joom_finder_links`
  MODIFY `link_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `joom_finder_taxonomy`
--
ALTER TABLE `joom_finder_taxonomy`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de la tabla `joom_finder_terms`
--
ALTER TABLE `joom_finder_terms`
  MODIFY `term_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `joom_finder_types`
--
ALTER TABLE `joom_finder_types`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `joom_languages`
--
ALTER TABLE `joom_languages`
  MODIFY `lang_id` int(11) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de la tabla `joom_menu`
--
ALTER TABLE `joom_menu`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=102;
--
-- AUTO_INCREMENT de la tabla `joom_menu_types`
--
ALTER TABLE `joom_menu_types`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de la tabla `joom_messages`
--
ALTER TABLE `joom_messages`
  MODIFY `message_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `joom_modules`
--
ALTER TABLE `joom_modules`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=90;
--
-- AUTO_INCREMENT de la tabla `joom_newsfeeds`
--
ALTER TABLE `joom_newsfeeds`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `joom_overrider`
--
ALTER TABLE `joom_overrider`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'Primary Key';
--
-- AUTO_INCREMENT de la tabla `joom_postinstall_messages`
--
ALTER TABLE `joom_postinstall_messages`
  MODIFY `postinstall_message_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT de la tabla `joom_privacy_consents`
--
ALTER TABLE `joom_privacy_consents`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `joom_privacy_requests`
--
ALTER TABLE `joom_privacy_requests`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `joom_redirect_links`
--
ALTER TABLE `joom_redirect_links`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `joom_tags`
--
ALTER TABLE `joom_tags`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de la tabla `joom_template_styles`
--
ALTER TABLE `joom_template_styles`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT de la tabla `joom_ucm_content`
--
ALTER TABLE `joom_ucm_content`
  MODIFY `core_content_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `joom_ucm_history`
--
ALTER TABLE `joom_ucm_history`
  MODIFY `version_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `joom_updates`
--
ALTER TABLE `joom_updates`
  MODIFY `update_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=78;
--
-- AUTO_INCREMENT de la tabla `joom_update_sites`
--
ALTER TABLE `joom_update_sites`
  MODIFY `update_site_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT de la tabla `joom_usergroups`
--
ALTER TABLE `joom_usergroups`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT de la tabla `joom_users`
--
ALTER TABLE `joom_users`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=608;
--
-- AUTO_INCREMENT de la tabla `joom_user_keys`
--
ALTER TABLE `joom_user_keys`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `joom_user_notes`
--
ALTER TABLE `joom_user_notes`
  MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `joom_viewlevels`
--
ALTER TABLE `joom_viewlevels`
